...
class HHExpenseRegisterPaymentWizard(models.TransientModel):

    _name = "hhexpense.register.payment.wizard"
    ...
    def _default_partner_id(self):
        ...
        expense_sheet = self.env['hhexpense.hhexpense'].browse(active_ids)
